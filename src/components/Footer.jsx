...
export const Footer = () =>{
    ...
    return (
        <div className="footer">
          ...
          <hr />
          <div style={{display:'flex',  justifyContent:'space-between',padding:'30px 0px 80px'}}>
              ...
              <div style={{color:'white'}}>
                  ...
                  <div style={{display:"flex", gap:'30px'}}>
                      <div>The site is protected by reCAPTCHA and the Google Privacy Policy and Terms of Service apply</div>
                      <div>	©2022 Uber Technologies Inc.</div>
                  </div>
              </div>
          </div>
           </div>
