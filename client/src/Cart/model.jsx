...
export const Modal=({ onClose })=>{
    ...
    return(
        ...
        <div onClick={onClose} 
         style={{display:"flex",justifyContent:"center",alignItems:"center", position: 'fixed', 
        left: 0, width:"100%", top: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.8)',height:"100vh"}}>
          {data ? <> <Debit /> </> : <> <div  className="modal-box" style={{width:"400px",height:"500px", background: 'white',}}
       ...
       {/* <div  className="modal-box" style={{width:"400px",height:"500px", background: 'white',}}
            onClick={e => e.stopPropagation()}
        >
